...
locals {
  ...
  check_s3_bucket_spoke_empty = local.account_mode == 1 && var.centralize_flow_log_bucket_name == "" ? file("If account_mode is spoke, centralize_flow_log_bucket_name must not be empty.") : null
  #hub check
